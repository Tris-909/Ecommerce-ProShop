    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, axios_1["default"].get('/api/products/toptier', {
                        params: {
                            category: category
                        }
                    })];
            case 1:
                ...
                switch (data[0].category) {
                    case 'laptops':
                        dispatch({
                            type: actionTypes_1.GET_TOP_LAPTOPS_SUCCESS,
                            payload: data
                        });
                        break;
                    case 'tvs':
                        dispatch({
                            type: actionTypes_1.GET_TOP_TVS_SUCCESS,
                            payload: data
                        });
                        break;
                    case 'phones':
                        dispatch({
                            type: actionTypes_1.GET_TOP_PHONES_SUCCESS,
                            payload: data
                        });
                        break;
                    case 'headphone':
                        dispatch({
                            type: actionTypes_1.GET_TOP_HEADPHONE_SUCCESS,
                            payload: data
                        });
                        break;
                    case 'game':
                        dispatch({
                            type: actionTypes_1.GET_TOP_GAMES_SUCCESS,
                            payload: data
                        });
                        break;
                    default:
